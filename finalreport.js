...
// function convertTemperature(startValue, endValue, scale) {
//     // I select the output element where the results will be displayed.
//     const outputElement = document.getElementById("output")
...
//     if (startValue > endValue) {
//         [startValue, endValue] = [endValue, startValue]; // Swap values when needed
//     }

//     // I create a `<ul>` element to list multiple temperature conversions
//     const resultList = document.createElement("ul")

//     // I use a `for` loop to go through range and convert each value.
//     for (let temp = startValue; temp <= endValue; temp++) {
...
//     // I apply the correct conversion formula based on the selected scale.
//     if (scale === "C") {
